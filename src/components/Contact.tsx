const socialLinks = [
  ...
  {
    href: "https://www.linkedin.com/in/khushal-neekhra-8ba53924b/",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.instagram.com/volt_l18/",
    icon: (
      <svg
        width="25"
        height="24"
  ...
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a
                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 text-zinc-950 active:bg-zinc-50/80 reveal-up"
                href={href}
                key={key}
                target="_blank"
              >
        ...
        <form
          action="https://getform.io/f/axookqqb"
          method="POST"
